...
namespace SistemaEnvases
{
    ...
    public partial class CAJONES : Form
    {
        ...
        public CAJONES(DataTable reporte, int quereporte)
        {
            InitializeComponent();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            hoja.Cells[3, 2] = "REPORTE DE INVENTARIO DE CAJONES DIARIO";
        ...
        private void reportegrid_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (nombrecolumna == "ENTRADAS")
            {
                ...
                Form3 ob = new  Form3(Reporte_Entradas, Datetimepickerrepor.Text, "ENTRADA", NOMBRE_ENVASE, NOMBRE_PROVEEDOR);
            ...
            else if (nombrecolumna == "SALIDAS")
            {
                ...
                Form3 ob = new Form3(Reporte_Salidas, Datetimepickerrepor.Text, "SALIDA", NOMBRE_ENVASE, NOMBRE_PROVEEDOR);
